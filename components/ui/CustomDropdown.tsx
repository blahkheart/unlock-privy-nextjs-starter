      ...
      {isOpen && typeof document !== "undefined"
        ? createPortal(
            <div
              ...
              className={`mt-0 w-56 rounded-md bg-gray-900 shadow-lg ring-1 ring-gray-700 focus:outline-none z-[100] ${contentClassName}`}
              role="menu"
...
export const CustomDropdownItem = ({
  ...
  return (
    <a
      href="#"
      onClick={handleClick}
      className={`text-white flex items-center w-full px-4 py-2 text-sm ${
        disabled
